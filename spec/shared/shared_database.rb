...
shared_examples 'a badass database' do
  ...
  describe 'a song' do
    ...
    it 'is created with id, artist, title, album, duration, key' do
      ...
      expect(@song.en_id).to eq('THISISANENID')
    end
    ...
    it 'can be retrieved by id' do
      ...
      expect(gotten_song.en_id).to eq('THISISANENID')
    end
    ...
    it 'can be updated' do
      ...
      db.update_song({ id: @song.id, en_id: 'ANOTHERENID'})
      ...
      expect(updated_song.en_id).to eq('ANOTHERENID')
    end
  ...
  describe 'song retrieval tests' do
    ...
    it 'gets a song by its en_id' do
      expect(db.get_song_by_en_id(@song1.en_id).id).to eq(@song1.id)
    end
